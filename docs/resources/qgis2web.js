...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [2488769.855665, 5047658.281145, 3184516.673123, 5497687.287572], maxZoom: 11, minZoom: 8
    })
});
...
map.getView().fit([2488769.855665, 5047658.281145, 3184516.673123, 5497687.287572], map.getSize());
